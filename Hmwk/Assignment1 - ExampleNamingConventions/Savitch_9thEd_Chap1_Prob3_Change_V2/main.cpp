 ...
 * Number of Coins represented as Shorts
 */
...
int main(int argc, char** argv) {
    ...
    unsigned short nQtr,nDimes,nNickls,nPenys;//Number for each coin
    ...
    totChng = nQtr*QTRVAL + nDimes*DIMEVAL + 
              nNickls*NKLVAL + nPenys*PNYVAL;
